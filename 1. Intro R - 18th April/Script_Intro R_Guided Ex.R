...
S<-paste("Patient","Entry number","Disease",sep=":",1:10);S
...
y[y==0]
# (c) Search for components dierent form 0.
y[y!=0]
# (d) How many elements of y are lower than 3?
length(y[y<3])

# 10. Consider the following vector: (12,14,35,7,6,12,5,22,7,17,9,11).
# (a) Use this vector to build a matrix (by column) of order 3  4 and print it in the R console.
